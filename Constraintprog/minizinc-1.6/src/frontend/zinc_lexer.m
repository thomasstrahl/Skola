...
get_token(LineNum, Tok, Src, !I, !S) :-
    ...
    ( if get_char(C, Src, !I, !S) then
        ...
        ( if is_whitespace(C)   then get_token(LineNum0, Tok, Src,     !I, !S),
          ...
          else if Lang = lang_flatzinc,
                  C = ('-')     then get_post_minus_f(   Tok, Src, I1, !I, !S)
          else if Lang = lang_flatzinc,
                  C = ('=')     then Tok = op("=")
          else if Lang = lang_flatzinc,
                  C = ('.')     then get_post_dot_f(     Tok, Src, I1, !I, !S)
          % Uncomment to get /* .. */ block comments in Zinc
                ...
                skip_char_if(unify('*'), Src, !I, !S) then
                  ...
                  is_op_char(C) then get_op_or_oplike(C, /*IsQuoted*/no,
                                                         Tok, Src, I1, !I, !S)
                  ...
                  C = '$'       then get_post_dollar(    Tok, Src, I1, !I, !S)
          else if C = '_'       then 
            (
                Lang = lang_flatzinc,
            ...
            ;
                ...
                get_post_underscore(Tok, Src, I1, !I, !S)
                  ...
                  C = '\''      then get_post_quote(     Tok, Src, I1, !I, !S)
          else if Lang \= lang_flatzinc,
                  C = '`'       then get_post_backquote( Tok, Src, I1, !I, !S)
          else
