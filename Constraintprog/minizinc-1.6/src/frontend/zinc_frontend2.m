...
do_analysis_stages(Ctrl, ProgramName, StageNames, Lang, Checking,
    ...
    (
        (
            Lang = lang_zinc,
            PPLang = pp_lang_zinc(print_coercions)
        ;
            Lang = lang_minizinc,
    ...
    ;
        % FlatZinc does not have separate assignment items and is not
        % topologically sorted.
        Lang = lang_flatzinc,
        PPLang = pp_lang_flatzinc(print_coercions),
        MaybeItems2 = MaybeItems0
    ),  
