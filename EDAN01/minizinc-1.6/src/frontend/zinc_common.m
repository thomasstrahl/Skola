...
zmf(Lang) :- list.member(Lang, [lang_zinc, lang_minizinc, lang_flatzinc]).
zm( Lang) :- list.member(Lang, [lang_zinc, lang_minizinc          ]).
z(  Lang) :- list.member(Lang, [lang_zinc                    ]).
mf( Lang) :- list.member(Lang, [      lang_minizinc, lang_flatzinc]).

:- instance show(lang) where [
    lang_zinc    ^show = "Zinc",
    lang_minizinc^show = "MiniZinc",
    lang_flatzinc^show = "FlatZinc"
].
