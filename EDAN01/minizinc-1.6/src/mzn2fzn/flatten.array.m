...
refine_array_var_items_bounds(Context, VarIdA, ItemsB, Z, !Env) :-
    ( if dynamic_cast(ItemsB, FloatItems0 : float_exprs) then
    ...
    else if dynamic_cast(ItemsB, IntItems0 : int_exprs) then
    ...
    else if dynamic_cast(ItemsB, SetItems : int_set_exprs) then
