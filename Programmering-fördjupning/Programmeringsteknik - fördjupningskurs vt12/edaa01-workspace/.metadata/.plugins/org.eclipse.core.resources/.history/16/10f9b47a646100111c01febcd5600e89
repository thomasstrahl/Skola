...
public class SimpleHashMap<K, V> implements Map<K, V> {
	...
	public static void main(String[] args) {
		...
		System.out.println(shm.index(1));
		System.out.println(shm.find(2,2));
		...
		shm.put(12, 12);
		shm.put(20, 20);
		System.out.println(shm.remove(10));
		System.out.println(shm.show());
	...
	public V remove(Object key) {
		...
		if (table[index]== null) {
		...
		else if (objectK.equals(table[index].getKey())) {
			...
			Entry <K,V> temp = find(index, objectK);
			if(temp != null){
				Entry <K,V> temp2 = table[index];
